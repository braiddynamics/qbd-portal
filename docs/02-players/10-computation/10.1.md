...
1. **The Topological Stability** [(§10.1.3)](/monograph/players/computation/10.1/#10.1.3): The argument establishes that logical qubit states correspond to stable minima in the topological complexity landscape.
2. **The Topological Distinctness** [(§10.1.4)](/monograph/players/computation/10.1/#10.1.4): The argument verifies that the basis states are topologically distinct and orthogonal under ambient isotopy.
3. **The Controllability** [(§10.1.5)](/monograph/players/computation/10.1/#10.1.5): The argument constructs transition Hamiltonians to prove that the states can be toggled via writhe shuffling.
4. **The Measurability (the **measurability lemma** [(§10.1.6)](/monograph/players/computation/10.1/#10.1.6), the **qubit optimality proof** [(§10.1.7)](/monograph/players/computation/10.1/#10.1.7)):** The argument defines the color charge observable to prove projective readouts and synthesizes these features to prove the optimality of the tripartite qubit.
...
The challenge in controlling this qubit lies in changing the state without changing the particle's identity (charge). If a twist were simply added, the electron would turn into a heavier, differently charged particle. The **transition hamiltonian construction** [(§10.1.5)](/monograph/players/computation/10.1/#10.1.5) solves this by using a "shuffle" operation. The process takes a twist from one ribbon and moves it to another. The total number of twists, and thus the total charge, stays constant at -3.
...
2.  **Indistinguishability:** Being Majorana-like **braids folded** [(§9.6.3)](/monograph/players/unification/9.6/#9.6.3), the particle and antiparticle states are topologically identified or difficult to distinguish in a computational basis.
...
2.  **Stability Failure:** As proven in **decay tunneling lemma** [(§9.3.4)](/monograph/players/unification/9.3/#9.3.4), these states decay into electrons via tunneling. Their finite lifetime introduces intrinsic decoherence (amplitude damping errors) that the ground-state electron avoids.
