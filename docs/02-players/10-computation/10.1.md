---
title: "Chapter 10: Quantum Universality (Computation)"
...
No decay channel exists to a lower energy state with the same charge invariant, as verified by the exhaustion of lower-complexity braids [(§9.6.3)](/monograph/players/unification/9.3/#9.6.3). Thus, $|0_L\rangle$ is absolutely stable.
