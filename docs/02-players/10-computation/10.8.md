...
The **T-gate definition** <Ref id="10.8.1" label="§10.8.1" /> introduces the "magic" ingredient needed for universal computation. The T-gate requires a phase rotation of $\pi/4$, which is geometrically subtle.
...
3. **The Twisting Morphism** <Ref id="10.8.7" label="§10.8.7" />: The argument instantiates the twisting morphism to construct the self-braiding operation.
4. **The Gate Action** <Ref id="10.8.8" label="§10.8.8" />: The argument combines these categorical structures to prove that the self-braiding operation implements the exact phase shift of pi over four required for the T-gate.
