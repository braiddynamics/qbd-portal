...
1. **The Singlet Transparency** [(§10.5.2)](/monograph/players/computation/10.5/#10.5.2): The argument proves that the symmetric ground state does not couple to the color probe, accumulating zero phase.
2. **The Color Phase Holonomy** [(§10.5.3)](/monograph/players/computation/10.5/#10.5.3): The argument demonstrates that the asymmetric excited state carries color charge, acquiring a geometric phase of pi.
3. **The Gate Action** [(§10.5.4)](/monograph/players/computation/10.5/#10.5.4): The argument combines these state-dependent phase responses to prove the execution of the logical Pauli-Z gate.
...
As proven in the **topological distinctness lemma** [(§10.1.4)](/monograph/players/computation/10.1/#10.1.4), this state is invariant under the permutation group $S_3$, implying it transforms as the singlet representation $\mathbf{1}$ under the color group $SU(3)$.
...
**I. Action on Basis**
Combining the results of the **singlet transparency lemma** [(§10.5.2)](/monograph/players/computation/10.5/#10.5.2) and the **color phase holonomy lemma** [(§10.5.3)](/monograph/players/computation/10.5/#10.5.3):
