...
1. **The Writhe Conservation (Lemma [§10.4.3]):** The argument proves that writhe-shuffling operations preserve the global writhe sum.
2. **The Charge Conservation (Lemma [§10.4.4]):** The argument verifies that the redistribution of writhe does not violate electric charge conservation.
3. **The Gate Action (Proof [§10.4.5]):** The argument demonstrates that the writhe-shuffling sequence implements the exact unitary transformation of the logical Pauli-X gate on basis states.
