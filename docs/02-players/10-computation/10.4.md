...
3. **The Gate Action** <Ref id="10.4.5" label="§10.4.5" />: The argument demonstrates that the writhe-shuffling sequence implements the exact unitary transformation of the logical Pauli-X gate on basis states.
