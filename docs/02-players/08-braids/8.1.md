...
1. **The Braid Isomorphism (Lemma [§8.1.2]):** The argument establishes that discrete rewrite operations on particle ribbons correspond exactly to the algebraic generators of the braid group.
2. **The Distant Commutativity and Yang-Baxter Relations (Lemma [§8.1.3], Lemma [§8.1.4]):** The argument proves that spatially separated swaps commute while adjacent swaps satisfy the Yang-Baxter relation, providing the algebraic constraints of the group.
3. **The Commutator Depth (Lemma [§8.1.5]):** The argument demonstrates that nested commutators of the braid generators close within a finite depth, defining a bounded Lie bracket structure.
4. **The Lie Algebra Emergence (Proof [§8.1.6]):** The argument combines these relations to prove that continuous gauge fields and Lie algebra generators emerge from the unitary evolution of the discrete braid graph.
