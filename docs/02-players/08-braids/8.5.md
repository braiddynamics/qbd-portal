...
Enumeration of the local degrees of freedom established in the Degree Counting the **degree counting proof** [(§8.5.6.1)](/monograph/players/braids/8.5/#8.5.6.1) is based on the following protocols:
...
Validation of the analytical coupling derivation established in the Synthesis the **coupling strength synthesis proof** [(§8.5.7)](/monograph/players/braids/8.5/#8.5.7) is based on the following protocols:
