...
def verify_gauge_coupling_consistency():
    ...
    # Source: **section 5.3** [(§5.3)](/monograph/rules/equilibrium/5.3/#5.3) (Fluctuations across 100 runs)
