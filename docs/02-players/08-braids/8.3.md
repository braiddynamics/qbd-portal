...
This inversion exposes pre-existing mediated paths as valid alternatives under the **Effective Influence** relation $\le$ **effective influence definition** [(§2.6.1)](/monograph/rules/axioms/2.6/#2.6.1).
