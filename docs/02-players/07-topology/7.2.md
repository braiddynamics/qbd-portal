...
By **Lemma 6.4.4** [(§6.4.4)](/monograph/players/fermions/6.4/#6.4.4), the formation of such a non-local structure constitutes a global topology change with an $O(N)$ energy barrier.
