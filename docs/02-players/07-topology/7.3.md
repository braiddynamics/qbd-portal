...
Let $\mathcal{O}_{loc}$ denote the set of all physically realizable operators generatable by the **Universal Constructor** $\mathcal{R}$ **universal constructor** [(§4.5.1)](/monograph/rules/dynamics/4.5/#4.5.1).
...
2.  **2-Cycle Case:** Creating a minimal twist involving two vertices requires edges $(u, v)$ and $(v, u)$.
    This structure violates Axiom 1 (Asymmetry) and the **Principle of Unique Causality (PUC)** [(§2.3.3)](/monograph/rules/axioms/2.3/#2.3.3), which forbids reciprocal causality and redundant paths.
