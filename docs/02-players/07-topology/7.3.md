...
1. **The Writhe Conservation (Lemma [§7.3.4]):** The argument proves that the total writhe of the tripartite braid remains invariant under local graph rewrites, establishing writhe as a conserved charge.
2. **The Lepton and Quark Spectrum (Lemma [§7.3.5], Lemma [§7.3.6]):** The argument derives integer charge values for symmetric singlet states and fractional charges for asymmetric triplet configurations.
3. **The Anomaly Normalization (Lemma [§7.3.7]):** The argument fixes the charge scale factor to exactly one-third by enforcing the cancellation of gauge anomalies in the first generation.
4. **The Charge Emergence (Proof [§7.3.8]):** The argument combines these topological solutions to prove that electric charge is an emergent, quantized representation of total braid twist.
