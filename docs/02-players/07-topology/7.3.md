...
From the **singlet charge values proof** <Ref id="7.3.5.1" label="§7.3.5.1" /> and the **triplet charge values proof** <Ref id="7.3.6.1" label="§7.3.6.1" />, the QBD charge spectrum for the first generation is:
