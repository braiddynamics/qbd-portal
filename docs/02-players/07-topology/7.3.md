...
1. **The Writhe Conservation** <Ref id="7.3.4" label="§7.3.4" />: The argument proves that the total writhe of the tripartite braid remains invariant under local graph rewrites, establishing writhe as a conserved charge.
...
3. **The Anomaly Normalization** <Ref id="7.3.7" label="§7.3.7" />: The argument fixes the charge scale factor to exactly one-third by enforcing the cancellation of gauge anomalies in the first generation.
4. **The Charge Emergence** <Ref id="7.3.8" label="§7.3.8" />: The argument combines these topological solutions to prove that electric charge is an emergent, quantized representation of total braid twist.
...
The **Minimal Generation Theorem** <Ref id="6.1.2" label="§6.1.2" /> dictates that the vacuum populates states in increasing order of topological complexity $C$.
...
The **Anomaly normalization lemma** <Ref id="7.3.7" label="§7.3.7" /> proves that $k=1/3$ is the unique normalization satisfying the definition of the fundamental charge unit and anomaly cancellation.
