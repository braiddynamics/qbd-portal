...
One of the subtle features of the Standard Model is that the Up and Down quarks possess almost the same mass (Isospin symmetry). In **Integer Geometric Efficiency** <Ref id="7.4.5" label="§7.4.5" />, this property receives a natural geometric explanation.
