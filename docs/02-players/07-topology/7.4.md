...
Quantification of the mass spectrum predicted by the Topological Mass Functional established in the Discrete Mass Spectrum Proof [(§7.4.6)](/monograph/players/topology/7.4/#7.4.6) is based on the following protocols:
