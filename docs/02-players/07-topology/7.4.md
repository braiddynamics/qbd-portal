...
2. **The Crossing Scaling** <Ref id="7.4.4" label="§7.4.4" />: The argument demonstrates that base complexity scales linearly with the minimal crossing count of the braid.
3. **The Geometric Sharing Efficiency** <Ref id="7.4.5" label="§7.4.5" />: The argument derives the sharing coefficients of parallel strands to account for isospin degeneracies.
4. **The Mass Spectrum** <Ref id="7.4.6" label="§7.4.6" />: The argument integrates the linear crossing and geometric sharing efficiency results to prove the discrete generational mass spectrum.
