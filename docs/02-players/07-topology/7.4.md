...
1. **The Thermodynamic Equivalence (Lemma [§7.4.3]):** The argument proves that entropic contributions vanish for protected topologies, isolating mass as a purely static complexity function.
2. **The Crossing Scaling (Lemma [§7.4.4]):** The argument demonstrates that base complexity scales linearly with the minimal crossing count of the braid.
3. **The Geometric Sharing Efficiency (Lemma [§7.4.5]):** The argument derives the sharing coefficients of parallel strands to account for isospin degeneracies.
4. **The Mass Spectrum (Proof [§7.4.6]):** The argument integrates the linear crossing and geometric sharing efficiency results to prove the discrete generational mass spectrum.
