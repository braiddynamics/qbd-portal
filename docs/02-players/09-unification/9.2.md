...
The intermediate states in both $\Sigma_A$ and $\Sigma_B$ satisfy the **Effective Influence** relation $\le$ **effective influence definition** [(§2.6.1)](/monograph/rules/axioms/2.6/#2.6.1), ensuring the move is a valid trajectory in the causal manifold.
...
Verification of the algebraic completeness established in the Isomorphism Verification the **isomorphism verification proof** [(§9.2.5.1)](/monograph/players/unification/9.2/#9.2.5.1) is based on the following protocols:
