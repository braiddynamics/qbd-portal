...
The Yang-Baxter equation appears again here, this time enforcing consistency on the 5-strand braid. Lemma 9.2.4 ensures that the order in which adjacent crossings (e.g., strands 2, 3, and 4) are resolved does not change the physical outcome.
