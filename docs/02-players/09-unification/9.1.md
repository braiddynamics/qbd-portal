...
Verification of the anomaly freedom condition established in the Uniqueness Verification the **uniqueness verification proof** [(§9.1.5)](/monograph/players/unification/9.1/#9.1.5) is based on the following protocols:
