...
4. **The Trapping Synthesis** <Ref id="9.3.5" label="§9.3.5" />: The argument combines complexity ordering, local barriers, and tunneling suppression to prove the lifetime metastability of the three-generation structure.
