...
The **Planck anchor lemma** <Ref id="9.6.8" label="§9.6.8" /> bridges the gap between the abstract complexity count and physical units by anchoring the critical complexity $N_{3,max}$ to the Planck Mass $M_{Pl}$.
