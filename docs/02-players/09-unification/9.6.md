...
Verification of the seesaw hierarchy established in the Neutrino Mass Demonstration the **neutrino mass chain proof** [(§9.6.9)](/monograph/players/unification/9.6/#9.6.9) is based on the following protocols:
