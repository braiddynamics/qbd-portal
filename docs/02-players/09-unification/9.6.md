...
Refined by the specific pre-factor from the **criticality verification proof** <Ref id="9.6.7.1" label="§9.6.7.1" />:
...
2.  **Seesaw Mechanism:** From the **mixing verification proof** <Ref id="9.6.4.1" label="§9.6.4.1" />, the mixing with a heavy partner yields $m_\nu \approx m_D^2 / M_R$.
3.  **Heavy Mass Scale:** From the **scaling verification proof** <Ref id="9.6.8.1" label="§9.6.8.1" />, vacuum friction limits the heavy partner mass to $M_R \approx 2 \times 10^{16}$ GeV.
