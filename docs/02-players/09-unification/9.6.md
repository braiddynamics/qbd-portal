...
As established in **Complexity Density Scaling** <Ref id="9.6.5" label="§9.6.5" />, a scaling law dictates that as more topological complexity ($N_3$) is packed into a particle, the local density of graph edges increases linearly.
