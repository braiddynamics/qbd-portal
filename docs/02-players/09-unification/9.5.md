...
1. **The Tension Verification** [(§9.5.2)](/monograph/players/unification/9.5/#9.5.2): The argument demonstrates that standard effective field theory calculations overpredict the proton decay rate, establishing the need for non-perturbative suppression.
2. **The Minimal Action Pathway** [(§9.5.3)](/monograph/players/unification/9.5/#9.5.3): The argument constructs the optimal trajectory through the topological configuration space, defining the minimal path for baryonic decay.
3. **The Action-Mass Proportionality** [(§9.5.4)](/monograph/players/unification/9.5/#9.5.4): The argument proves that the tunneling action scales linearly with the leptoquark's topological complexity, providing an immense potential barrier.
4. **The Stability Synthesis** [(§9.5.5)](/monograph/players/unification/9.5/#9.5.5): The argument combines the path and action scaling constraints to prove that leptoquark-mediated proton decay is exponentially suppressed, matching experimental bounds.
...
2.  **Channel B: $p \to \mu^+ + K^0$**
    * **Muon ($\mu^+$):** Generation 2 anti-lepton. As proven in the **complexity ordering lemma** [(§9.3.2)](/monograph/players/unification/9.3/#9.3.2), $C_{\mu} > C_{e}$.
...
Combining the **tension verification lemma** [(§9.5.2)](/monograph/players/unification/9.5/#9.5.2) (EFT inadequacy) and the **action-mass proportionality lemma** [(§9.5.4)](/monograph/players/unification/9.5/#9.5.4) (Topological Action), the full decay rate is given by the product of the perturbative term and the non-perturbative topological factor:
