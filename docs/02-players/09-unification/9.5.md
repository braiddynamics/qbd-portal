...
Quantification of the failure of perturbative methods established in the Decay Rate Calculation the **decay rate calculation proof** [(§9.5.2.1)](/monograph/players/unification/9.5/#9.5.2.1) is based on the following protocols:
