...
Quantification of the failure of perturbative procedures established in the Decay Rate Calculation the **Decay Rate Calculation Proof** [(§9.5.2.1)](/monograph/players/unification/9.5/#9.5.2.1) is based on the following protocols:
