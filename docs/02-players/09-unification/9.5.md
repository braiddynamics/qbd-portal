...
From the **Topological Mass Theorem** <Ref id="7.4.4" label="§7.4.4" />, the mass of a particle is linear in its topological complexity (quanta count):
