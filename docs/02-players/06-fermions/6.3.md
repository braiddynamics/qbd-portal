...
Given that mass $m$ is defined as the informational inertia proportional to $N_3$ [(§7.4.1)](/monograph/players/topology/#7.4.1), it follows that mass scales linearly with the crossing number.
