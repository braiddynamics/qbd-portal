...
1. **The Crossing Scaling** [(§6.3.4)](/monograph/players/fermions/6.3/#6.3.4): The argument proves that crossing complexity scales linearly with the minimal crossing number, establishing the base mass contribution from braiding.
2. **The Torsional Scaling** [(§6.3.5)](/monograph/players/fermions/6.3/#6.3.5): The argument derives the quadratic scaling of torsional complexity, showing that twisting forces require a quadratic increase in geometric resources to satisfy causal partial ordering.
3. **The Entropic Vanishing** [(§6.3.6)](/monograph/players/fermions/6.3/#6.3.6): The argument proves that entropic fluctuations vanish for topologically protected states, allowing mass to be modeled strictly as a function of static complexity.
4. **The Synthesis** [(§6.3.7)](/monograph/players/fermions/6.3/#6.3.7): The argument combines the linear crossing, quadratic torsional, and entropic parsimony results to synthesize the total topological mass functional.
...
Given that mass $m$ is defined as the informational inertia proportional to $N_3$ **mass as informational inertia definition** [(§7.4.1)](/monograph/players/topology/7.4/#7.4.1), it follows that mass scales linearly with the crossing number.
...
The **linear scaling of crossings lemma** [(§6.3.4)](/monograph/players/fermions/6.3/#6.3.4) formalizes the intuition that a complex knot constitutes a sum of simple crossings. In the sparse regime of the vacuum, local defects do not strongly interact with distant ones; the finite correlation length $\xi$ screens them from one another. Therefore, constructing a braid by adding crossings sequentially results in a total requirement of 3-cycles that equals the simple sum of the cycles required for each individual crossing.
...
This commentary provides the physical interpretation for the quadratic scaling derived in the **torsional scaling lemma** [(§6.3.5)](/monograph/players/fermions/6.3/#6.3.5). The question of why the Top quark possesses a mass orders of magnitude larger than the Up quark finds its answer here: the **Pathfinding Penalty**. within a discrete graph, space lacks infinite divisibility. Adding writhe (twist) to a ribbon effectively packs more causal information into a fixed volume.
...
This state resides within the **QECC Codespace** $\mathcal{C}$ **quantum error-correcting codespace** [(§3.5.7)](/monograph/rules/architecture/3.5/#3.5.7).
...
From the **crossing scaling lemma** [(§6.3.4)](/monograph/players/fermions/6.3/#6.3.4), the number of Geometric Quanta required for the crossing structure is $N_3^{\text{crossings}} = k_c C[\beta]$.  
From the **torsional scaling lemma** [(§6.3.5)](/monograph/players/fermions/6.3/#6.3.5), the number required for the torsional structure is $N_3^{\text{torsion}} = k_t w(\beta)^2$.
...
From the **entropic vanishing lemma** [(§6.3.6)](/monograph/players/fermions/6.3/#6.3.6), the entropy vanishes within the protected codespace, yielding $F[\beta] = U[\beta]$.  
