...
The operation $\mathcal{R}_{M+1}$ must satisfy **Principle of Unique Causality (PUC)** <Ref id="2.3.3" label="§2.3.3" />, which explicitly forbids the creation of redundant paths (bubbles) of length $\le 2$.
