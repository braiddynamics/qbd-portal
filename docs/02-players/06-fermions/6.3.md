...
Verification of the non-linear complexity growth established in the Scaling the the **scaling proof** [(§6.3.5.1)](/monograph/players/fermions/6.3/#6.3.5.1) is based on the following protocols:
