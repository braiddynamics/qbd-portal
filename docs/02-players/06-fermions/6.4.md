...
Validation of the operational limits established in the Local Blindness the **local blindness proof** [(§6.4.3.1)](/monograph/players/fermions/6.4/#6.4.3.1) is based on the following protocols:
