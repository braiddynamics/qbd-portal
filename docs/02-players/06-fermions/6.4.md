...
By the **Reducibility** [(§6.1.3)](/monograph/players/fermions/6.1/#6.1.3), there exists a local sequence $\mathcal{S}_{loc}$ of Type II/III moves that reduces the crossing number $C[\xi]$.
...
By the **Global Unwinding Barrier** [(§6.4.4)](/monograph/players/fermions/6.4/#6.4.4), the cost of Global Unwinding is $O(N)$.
By the **Local Horizon** [(§6.4.3)](/monograph/players/fermions/6.4/#6.4.3), the local operator $\mathcal{R}$ is blind to the global gradient required to guide this $O(N)$ process.
