...
The **Generator Principle** [(§8.1)](/monograph/players/braids/8.1/#8.1) establishes the map from braid generators $\sigma_i$ to Lie algebra generators $\hat{H}_i$ via the exponential map.
