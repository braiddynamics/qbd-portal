...
Quantification of the formation probabilities for higher-order structures established in the Analytical Exclusion the **analytical exclusion via tqft parsimony proof** [(§6.2.6.1)](/monograph/players/fermions/6.2/#6.2.6.1) is based on the following protocols:
