...
2. **The Filter (established by **Exclusion of Reflexivity and Reciprocity** <Ref id="3.1.5" label="§3.1.5" />, **Exclusion of Cyclic Paths** <Ref id="3.1.6" label="§3.1.6" />, and **Global Acyclicity** <Ref id="3.1.7" label="§3.1.7" />):** The argument systematically excludes all cyclic topologies, proving that reflexivity, reciprocity, and higher-order loops violate causal constraints and restricting the vacuum to a directed acyclic graph.
3. **The Topology (established by **Global Connectivity** <Ref id="3.1.8" label="§3.1.8" /> and **Path Uniqueness and Sparsity** <Ref id="3.1.9" label="§3.1.9" />):** The argument enforces tree sparsity, demonstrating that any excess edge density creates redundant paths that violate the Principle of Unique Causality.
4. **The Bipartition (established by **Depth-Parity Bipartition** <Ref id="3.1.10" label="§3.1.10" />, **Exclusion of Odd Cycles** <Ref id="3.1.11" label="§3.1.11" />, and **Demonstration of the Vacuum Structure** <Ref id="3.1.12" label="§3.1.12" />):** The argument identifies the depth-parity bipartition, proving that odd-length cycles are topologically suppressed and isolating the directed tree as the unique initial state.
