...
3.  **Fundamental Graph Structures:**
      * **Directed Acyclic Graph (DAG):** A graph containing no **directed cycles** [(§1.5.1)](/monograph/rules/ontology/1.5/#1.5.1).
...
5.  **Acyclicity:** The graph contains no **Directed Cycles** [(§1.5.3)](/monograph/rules/ontology/1.5/#1.5.3) and no redundant **parallel paths** [(§2.3.3)](/monograph/rules/axioms/2.3/#2.3.3).
...
The **Depth-Parity Bipartition** establishes the bipartition $(V_{	ext{even}}, V_{	ext{odd}})$ [(§3.1.10)](/monograph/rules/architecture/3.1/#3.1.10). No edges exist within $V_{\text{even}}$ or within $V_{\text{odd}}$.
...
:::tip[the **Formal Derivation of the Finite Rooted Tree Topology via Sequential Exclusion** [(§3.1.3)](/monograph/rules/architecture/3.1/#3.1.3)]
:::
