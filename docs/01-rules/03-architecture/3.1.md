...
4. **The Bipartition (the **the depth-parity bipartition lemma** [(§3.1.10)](/monograph/rules/architecture/3.1/#3.1.10), the **exclusion of odd cycles lemma** [(§3.1.11)](/monograph/rules/architecture/3.1/#3.1.11), the **demonstration of the vacuum structure proof** [(§3.1.12)](/monograph/rules/architecture/3.1/#3.1.12)):** The argument identifies the depth-parity bipartition, proving that odd-length cycles are topologically suppressed and isolating the directed tree as the unique initial state.
...
Verification of the global causal consistency established in the Global Acyclicity the **global acyclicity proof** [(§3.1.7.1)](/monograph/rules/architecture/3.1/#3.1.7.1) is based on the following protocols:
...
Validation of the entropic penalty for disconnected topologies established in the Minimization of Automorphisms the **minimization of automorphisms proof** [(§3.1.8.1)](/monograph/rules/architecture/3.1/#3.1.8.1) is based on the following protocols:
...
* The number $3$ is **Odd**.
* The vacuum is **Bipartite** (the **the depth-parity bipartition lemma** [(§3.1.10)](/monograph/rules/architecture/3.1/#3.1.10)).
