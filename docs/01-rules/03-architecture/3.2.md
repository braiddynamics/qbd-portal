...
1.  **Topological Area Exclusion** <Ref id="3.2.2" label="§3.2.2" />: The argument eliminates candidate graphs with cycles of length three or greater, ensuring the vacuum has infinite girth.
2.  **Short Range Exclusion** <Ref id="3.2.3" label="§3.2.3" />: The lemma excludes self-loops and reciprocal edges, preventing primitive cycles from violating irreflexivity.
3.  **Unified Causal Connectivity** <Ref id="3.2.4" label="§3.2.4" />: The step rejects disconnected configurations, establishing a single connected causal framework.
4.  **Causal Redundancy Elimination** <Ref id="3.2.5" label="§3.2.5" />: The argument prunes graphs with redundant causal paths, forcing exact tree sparsity to maintain causal clarity.
5.  **Branching Site Maximization** <Ref id="3.2.6" label="§3.2.6" />: The lemma optimizes branching factor to maximize the density of active rewrite sites, accelerating geometric growth.
6.  **Symmetric Degree Regularity** <Ref id="3.2.7" label="§3.2.7" />: The proof establishes degree uniformity among internal nodes, ensuring spatial isotropy and homogeneous physical laws.
7.  **Generational Orbit Transitivity** <Ref id="3.2.8" label="§3.2.8" />: The step enforces balanced level-transitive branching, eliminating positional privilege across equivalent depth nodes.
8.  **Symmetry Entropy Balance** <Ref id="3.2.9" label="§3.2.9" />: The lemma defines a weighted optimality score that evaluates candidate vacuum graphs based on global symmetry and local homogeneity.
9.  **Quantitative Supremacy Verification** <Ref id="3.2.10" label="§3.2.10" />: The theorem proves the regular Bethe fragment uniquely maximizes the structural optimality metric.
10. **Optimal Vacuum Derivation** <Ref id="3.2.11" label="§3.2.11" />: The proof combines these selective filters to uniquely derive the regular Bethe fragment as the vacuum state.
