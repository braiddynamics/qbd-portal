...
### 3.2.2 Diagram: Fragment Topology {#3.2.2}
...
### 3.2.3.1 Commentary: Argument Outline {#3.2.3.1}
...
```text
• 3.2.3 Theorem Optimal Vacuum  [by exclusion]
├── 3.2.4 Lemma: Exclusion of Cyclic Topologies
│   └── 3.2.4.1 Proof: Exclusion of Cyclic Topologies
│
├── 3.2.5 Lemma: Exclusion of Short-Range Loops
│   └── 3.2.5.1 Proof: Exclusion of Short-Range Loops
│
├── 3.2.6 Lemma: Exclusion of Disconnected States
│   ├── 3.2.6.1 Proof: Exclusion of Disconnected States
│   └── 3.2.6.2 Commentary: One Universe
│
├── 3.2.7 Lemma: Exclusion of Redundant DAGs
│   ├── 3.2.7.1 Proof: Exclusion of Redundant DAGs
│   └── 3.2.7.2 Commentary: Efficiency of Sparsity
│
├── 3.2.8 Lemma: Site Maximality
│   ├── 3.2.8.1 Proof: Site Maximality
│   └── 3.2.8.2 Commentary: Parallel Processing
│
├── 3.2.9 Lemma: Degree Regularity
│   ├── 3.2.9.1 Proof: Degree Regularity
│   ├── 3.2.9.2 Calculation: Entropy Comparison
│   └── 3.2.9.3 Commentary: Democracy of the Vacuum
│
├── 3.2.10 Lemma: Orbit Transitivity
│   ├── 3.2.10.1 Proof: Orbit Transitivity
│   └── 3.2.10.2 Commentary: Symmetry Breaking
│
├── 3.2.11 Lemma: Structural Optimality Metric
│   └── 3.2.11.1 Proof: Structural Optimality Metric
│
├── 3.2.12 Lemma: Quantitative Supremacy
│   ├── 3.2.12.1 Proof: Quantitative Supremacy
│   ├── 3.2.12.2 Commentary: Quantitative Bounds
│   ├── 3.2.12.3 Calculation: Small N Census
│   └── 3.2.12.4 Calculation: Large Depth Scaling
│
└── 3.2.13 Proof: Optimal Vacuum
```
...
### 3.2.4.2 Commentary: Cycle Exclusion {#3.2.4.2}
...
### 3.2.5.2 Commentary: Short Loop Exclusion {#3.2.5.2}
...
### 3.2.6.2 Commentary: One Universe {#3.2.6.2}
...
### 3.2.7.2 Commentary: Efficiency of Sparsity {#3.2.7.2}
...
### 3.2.8.2 Commentary: Parallel Processing {#3.2.8.2}
...
### 3.2.9.3 Commentary: Democracy of the Vacuum {#3.2.9.3}
...
### 3.2.10.2 Commentary: Symmetry Breaking {#3.2.10.2}
...
The vacuum must be maximally symmetric, meaning it should not contain any information that allows an observer to say "I am on the special branch." Everyone at generation $N$ should see the exact same causal horizon, indistinguishable from any other observer at the same generation. **Orbit Transitivity** <Ref id="3.2.10" label="§3.2.10" /> forces the tree to be **Balanced**: every branch must look exactly like every other branch. This symmetry is the discrete precursor to the **Cosmological Principle** (homogeneity and isotropy), ensuring that the laws of physics do not vary depending on which "branch" of the universe you inhabit. The vacuum effectively hides its own history, appearing identical in all directions from the perspective of any internal observer.
...
### 3.2.11.2 Commentary: Structural Optimality {#3.2.11.2}
...
### 3.2.12.2 Commentary: Quantitative Bounds {#3.2.12.2}
...
2. Lemma 3.2.4: Geometric Viability (k<=3)    | 37         | 69 (Stars/Hubs)
3. Lemma 3.2.8: Site Maximality               | 36         | 1 (Linear Chains)
4. Lemma 3.2.9: Strict Regularity             | 2          | 34 (Irregular)
----------------------------------------------------------------------
