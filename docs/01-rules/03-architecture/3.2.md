...
4. **The Metric Convergence (the **the structural optimality metric lemma** [(§3.2.9)](/monograph/rules/architecture/3.2/#3.2.9), the **quantitative supremacy theorem** [(§3.2.10)](/monograph/rules/architecture/3.2/#3.2.10), the **demonstration of the optimal vacuum proof** [(§3.2.11)](/monograph/rules/architecture/3.2/#3.2.11)):** The argument evaluates the remaining candidates against the structural optimality metric, proving the quantitative supremacy of the regular tree configuration over all alternative graphs.
...
Investigation of the entropic properties of regular versus irregular structures established in the Regularity Mandate the **degree regularity proof** [(§3.2.7.1)](/monograph/rules/architecture/3.2/#3.2.7.1) is based on the following protocols:
...
Verification of the Regular Bethe Fragment as the unique maximizer established in the Supremacy Verification the **supremacy verification proof** [(§3.2.10.1)](/monograph/rules/architecture/3.2/#3.2.10.1) is based on the following protocols:
...
Quantification of the scaling behavior of the Bethe fragment established in the Regularity Mandate the **degree regularity proof** [(§3.2.7.1)](/monograph/rules/architecture/3.2/#3.2.7.1) is based on the following protocols:
