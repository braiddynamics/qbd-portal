...
The physical state of the universe at Logical Time $t$ **Dual Time Architecture** <Ref id="1.2.1" label="§1.2.1" /> is defined as the **Annotated Directed Graph** $G_t = (V, E, \mathcal{A})$.
