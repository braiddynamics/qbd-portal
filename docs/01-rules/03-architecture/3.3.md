...
3.  **Timestamp Ordering:** The site satisfies the strict **requirements monotonicity strict**[(§2.6.3)](/monograph/rules/axioms/2.6/#2.6.3).
...
Analysis of the scheduler's impact on vacuum symmetry established in the Overlap Determinism the **conflict resolution proof** [(§3.3.5.1)](/monograph/rules/architecture/3.3/#3.3.5.1) is based on the following protocols:
