...
The four formal assumptions $(A1)$ through $(A4)$ represent the direct encoding of the fundamental physical principles required to establish true background independence, relational uniformity, and the complete absence of privileged reference frames within the quantum vacuum.
