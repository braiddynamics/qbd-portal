...
The initial vacuum state $G_0$ constitutes a metastable **False Vacuum** characterized by **bipartiteness strict** [(§3.1.10)](/monograph/rules/architecture/3.1/#3.1.10), which topologically prohibits the formation of **Geometric Quanta** [(§2.3.2)](/monograph/rules/axioms/2.3/#2.3.2). It is asserted that a single non-perturbative **Tunneling Event** suffices to nucleate a seed that breaks the $\mathbb{Z}_2$ parity symmetry, generates the first compliant **sites rewrite compliant**[(§3.3.2)](/monograph/rules/architecture/3.3/#3.3.2), and initiates a first-order phase transition to the geometric vacuum.
...
:::tip[**Formal Derivation of the Deterministic Transition to Geometry via **Thermodynamic Probability** [(§3.4.1)](/monograph/rules/architecture/3.4/#3.4.1)**]
:::
...
Quantification of the ignition robustness established in the High-T Probability the **ignition probability proof** [(§3.4.5.1)](/monograph/rules/architecture/3.4/#3.4.5.1) is based on the following protocols:
