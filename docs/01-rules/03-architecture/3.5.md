...
The **Axiom of Geometric Constructibility** [(§2.3.1)](/monograph/rules/axioms/2.3/#2.3.1) forbids edges between non-adjacent vertices in the vacuum. For any pair $(u, v)$ with undirected distance $d(u, v) > 1$, define:
