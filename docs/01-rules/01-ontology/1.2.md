...
### 1.2.1.1 Commentary: Dual Temporal Scales {#1.2.1.1}
...
### 1.2.2.1 Commentary: Relational Proper Duration {#1.2.2.1}
...
### 1.2.3.1 Commentary: Ontological Status {#1.2.3.1}
...
### 1.2.3.2 Commentary: Computational Cosmology {#1.2.3.2}
...
### 1.2.3.3 Commentary: Unimodular Gravity {#1.2.3.3}
...
### 1.2.3.4 Commentary: Background Independence {#1.2.3.4}
...
### 1.2.4.1 Commentary: Argument Outline {#1.2.4.1}
...
```text
• 1.2.4 Theorem Temporal Finitude  [by contradiction]
│
├── 1.2.5 Lemma Finite Information Substrate
│   └── 1.2.5.1 Proof Finite Information Substrate
│
├── 1.2.6 Lemma Backward Accumulation
│   └── 1.2.6.1 Proof Backward Accumulation
│
├── 1.2.7 Lemma Finite State Recurrence
│   └── 1.2.7.1 Proof Finite State Recurrence
│
├── 1.2.8 Lemma Supertask Impossibility
│   ├── 1.2.8.1 Proof Supertask Limits
│   └── 1.2.8.2 Commentary Collapse of Supertasks
│
└── 1.2.9 Proof Temporal Finitude
    ├── 1.2.9.1 Commentary Grim Reaper Paradox
    └── 1.2.9.2 Diagram Grim Reaper Paradox
```
...
1.  **Thermodynamic Positivity:**
    ...
    The fluctuations are bounded by the **Finite Information Substrate** <Ref id="1.2.5" label="§1.2.5" />:
...
4.  **Contradiction:**
    The divergence $S(U_0) \to \infty$ is excluded by the **Finite Information Substrate** <Ref id="1.2.5" label="§1.2.5" />.
...
4.  **Contradiction:**
    An infinite information capacity $I(U_0) = \infty$ is excluded by the **Finite Information Substrate** <Ref id="1.2.5" label="§1.2.5" />.
...
### 1.2.8.2 Commentary: Collapse of Supertasks {#1.2.8.2}
...
### 1.2.9.1 Commentary: Grim Reaper Paradox {#1.2.9.1}
...
### 1.2.9.2 Diagram: Grim Reaper Paradox {#1.2.9.2}
