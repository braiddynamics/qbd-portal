...
In the primordial vacuum, additions predominate, kindling quanta from relational sparsity akin to inflationary nucleation. In the equilibrated manifold, deletions enforce entropic bounds, sculpting cosmic voids without retroactive erasure of histories. This symmetry anticipates the master equation's **balance flux equation's**[(§5.2.2)](/monograph/rules/equilibrium/5.2/#5.2.2): net complexity accrues not from intrinsic bias but from the geometry of task densities, with the vacuum itself functioning as the universal catalyst (a persistent topological scaffold that facilitates substitutions while invariant under its own isomorphism class). Physically, this duality mirrors the Lagrangian's dual gradients: ascent through addition, descent through deletion, tracing geodesics of minimal informational action across the task landscape. The substrate's impartiality thus preserves: $\mathfrak{T}$ as neutral potential, awaiting the chiral adjudication of axioms and thermodynamic engines to impart directionality, much as parity violation selects helicity from symmetric braids in the fermionic sector.
...
A defining virtue of this task-theoretic formulation resides in its kinematic purity: membership in $\mathfrak{T}$ invokes no oracle of probability, no calculus of free energy, nor any measure of dynamical preferability. The space enumerates merely the structural feasibility of flux, remaining agnostic to enactment frequency or energetic toll. An addition $\mathfrak{T}_{add}(u,v)$ qualifies if irreflexive and **timestampable** [(§1.3.4)](/monograph/rules/ontology/1.3/#1.3.4), but its thermodynamic viability ($\Delta F < 0$ at vacuum temperature) defers to **adjudication later** [(§4.5.3)](/monograph/rules/dynamics/4.5/#4.5.3). Deletions preserve $H$'s monotonicity yet postpone Landauer costs until **accounting erasure until**[(§4.5.5)](/monograph/rules/dynamics/4.5/#4.5.5). This stratification upholds the **hierarchy coherentist** [(§1.1.6)](/monograph/rules/ontology/1.1/#1.1.6): ontology affords the task space, axioms constrain **repertoire its constrain**[(§2.3.3)](/monograph/rules/axioms/2.3/#2.3.3), and dynamics **selection impose dynamics**[(§4.5.1)](/monograph/rules/dynamics/4.5/#4.5.1). The vacuum's constructor (the persistent relationality) thus emerges as the agent of becoming: persistent yet enabling the full cycle of construction that begets the universe from nullity. This independence ensures modularity: alterations to dynamical parameters (e.g., temperature scaling) perturb selection without reshaping kinematic possibility, facilitating isolation of ontology from mechanism and permitting the theory's scalability across regimes.
