...
### 1.5.1.1 Commentary: Causal Order and Posets {#1.5.1.1}
...
### 1.5.2.1 Diagram: Bipartite Structure {#1.5.2.1}
...
### 1.5.2.2 Commentary: State Space Partitions {#1.5.2.2}
...
### 1.5.3.1 Diagram: Directed Path Flow {#1.5.3.1}
...
### 1.5.3.2 Commentary: Transitive Causal Flow {#1.5.3.2}
...
### 1.5.4.1 Commentary: Non-Intersecting Trajectories {#1.5.4.1}
...
### 1.5.5.1 Diagram: Open 2-Path {#1.5.5.1}
...
### 1.5.5.2 Commentary: Transitive Mediation {#1.5.5.2}
...
### 1.5.6.1 Commentary: Causal Closure and Feedback {#1.5.6.1}
...
### 1.5.7.1 Diagram: Closed 2-Cycle {#1.5.7.1}
...
### 1.5.7.2 Commentary: Reciprocal Causality {#1.5.7.2}
...
### 1.5.8.1 Diagram: Closed 3-Cycle {#1.5.8.1}
...
### 1.5.8.2 Commentary: Minimal Area and Geometry {#1.5.8.2}
