...
Verification of the structural claims established in the Partial Order Property Proof [(§4.2.9.1)](/monograph/rules/dynamics/4.2/#4.2.9.1) is based on the following protocols:
