...
1. **The Generative Drive (Definition [§4.5.3], Theorem [§4.5.4]):** The constructor identifies compliant two-paths and computes addition probabilities, driving the generation of new geometric connectivity in sparse regions.
2. **The Pruning Balance (Definition [§4.5.5], Theorem [§4.5.6]):** The constructor scans for existing three-cycles and computes deletion probabilities, balancing growth with stress-driven pruning.
3. **The Adaptive Feedback (Definition [§4.5.2]):** The constructor modulates rewrite rates via the catalytic tension factor, establishing a self-regulating dynamical feedback loop that stabilizes the system.
