...
From the **Thermodynamic Foundations** [(§4.4)](/monograph/rules/dynamics/4.4/#4.4), the creation of a geometric quantum (3-cycle) entails:
...
Consider the case with finite energy cost $\epsilon_{geo} = \frac{\ln 2}{4}$ [(§4.4.4)](/monograph/rules/dynamics/4.4/#4.4.4).
