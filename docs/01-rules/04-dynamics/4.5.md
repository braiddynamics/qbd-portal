...
1. **The Generative Drive (the **addition mode definition** [(§4.5.3)](/monograph/rules/dynamics/4.5/#4.5.3), the **addition probability theorem** [(§4.5.4)](/monograph/rules/dynamics/4.5/#4.5.4)):** The constructor identifies compliant two-paths and computes addition probabilities, driving the generation of new geometric connectivity in sparse regions.
2. **The Pruning Balance (the **deletion mode definition** [(§4.5.5)](/monograph/rules/dynamics/4.5/#4.5.5), the **deletion probability theorem** [(§4.5.6)](/monograph/rules/dynamics/4.5/#4.5.6)):** The constructor scans for existing three-cycles and computes deletion probabilities, balancing growth with stress-driven pruning.
