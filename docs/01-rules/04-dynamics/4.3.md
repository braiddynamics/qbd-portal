...
Computational verification of the categorical consistency established by **The Awareness Comonad** <Ref id="4.3.10" label="§4.3.10" /> proceeds according to the following protocols:
