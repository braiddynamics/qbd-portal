...
Verification of the emergent probability weights established in the **Born Rule Derivation** [(§4.6.2)](/monograph/rules/dynamics/4.6/#4.6.2) is based on the following protocols:
...
Quantification of the information loss inherent in the Time Evolution Operator $\mathcal{U}$ established in the Irreversibility the **the thermodynamic arrow theorem** [(§4.6.3)](/monograph/rules/dynamics/4.6/#4.6.3) is based on the following protocols:
