...
:::tip[the **Formal Synthesis of Independence via Orthogonal Counter-Models** [(§2.5.1)](/monograph/rules/axioms/2.5/#2.5.1)]
:::
...
1.  **Direction 1 ($\neg(Ax1 \implies Ax2)$):**
    * *Model Construction:* the **Independence Case a** [(§2.5.2)](/monograph/rules/axioms/2.5/#2.5.2) constructs a graph $G_A$ consisting of a chordless directed $4$-cycle.
...
2.  **Direction 2 ($\neg(Ax2 \implies Ax1)$):**
    * *Model Construction:* the **Independence Case B** [(§2.5.3)](/monograph/rules/axioms/2.5/#2.5.3) constructs a graph $G_B$ consisting of a disjoint union of a valid $3$-cycle and an isolated self-loop ($C_3 \cup \{e_{loop}\}$).
