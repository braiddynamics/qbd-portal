...
The **Effective Influence** relation $\le$ **effective influence definition** [(§2.6.1)](/monograph/rules/axioms/2.6/#2.6.1) is axiomatically constrained to form a **Strict Partial Order** over the set of vertices $V$. This imposes the following global topological constraints:
...
:::tip[**Formal Proof of the Thermodynamic Enforcement the **local rewrite rule theorem** [(§2.7.2)](/monograph/rules/axioms/2.7/#2.7.2) via Demonstration of Energy Divergence**]
:::
