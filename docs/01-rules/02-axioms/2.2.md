...
1. **The Topological Identification** <Ref id="2.2.2" label="§2.2.2" />: The argument establishes that a reflexive edge is topologically identical to a directed cycle of length one, proving that any relation permitting reflexivity violates acyclicity.
...
3. **The Counter-Model** <Ref id="2.2.4" label="§2.2.4" />: The argument constructs a formal model that satisfies mathematical antisymmetry yet fails causal validity, establishing the absolute necessity of irreflexivity.
...
1.  **Topological Pathology** <Ref id="2.2.2" label="§2.2.2" />: It is established that a reflexive edge $e = (u, u)$ constitutes a directed cycle of length $k=1$. The existence of such a structure stands in direct violation of the **Global Acyclicity** requirement, which is essential for defining a valid causal history.
...
### 2.2.4.1 Commentary: Loophole of Equality {#2.2.4.1}
