...
Let $v$ denote a vertex participating in a Geometric Quantum (Directed $3$-Cycle) with strictly increasing timestamps along the edges. Then the Effective Influence relation satisfies the reflexive condition $v \le v$, violating the global **global acyclicity** [(§2.7.1)](/monograph/rules/axioms/2.7/#2.7.1).
...
:::tip[the **Formal Proof of Inadequacy via the Synthesis of Transitive Failures** [(§2.6.2)](/monograph/rules/axioms/2.6/#2.6.2)]
:::
