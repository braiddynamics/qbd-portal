...
The characteristic size of each volume is set by the correlation length $\xi$ derived in the **correlation decay lemma** [(§5.1.3)](/monograph/rules/equilibrium/5.1/#5.1.3).
$$
...
Quantification of the subextensive boundary term and verification of the independence assumption established in the Boundary Phase Stability Proof [(§5.1.4)](/monograph/rules/equilibrium/5.1/#5.1.4) is based on the following protocols:
