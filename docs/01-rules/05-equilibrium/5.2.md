...
Verification of the combinatorial derivation established in the **Growth Term Derivation** [(§5.2.4)](/monograph/rules/equilibrium/5.2/#5.2.4) is based on the following protocols:
...
Validation of the exponential suppression factor established in the **Friction Term Derivation** [(§5.2.5)](/monograph/rules/equilibrium/5.2/#5.2.5) is based on the following protocols:
...
Validation of the catalytic stress term established in the **Instability Derivation** [(§5.2.6)](/monograph/rules/equilibrium/5.2/#5.2.6) is based on the following protocols:
