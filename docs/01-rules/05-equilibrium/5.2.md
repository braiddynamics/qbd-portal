...
Computational verification of the master equation's equilibrium properties established by **Master Equation** <Ref id="5.2.7" label="§5.2.7" /> is based on the following protocols:
