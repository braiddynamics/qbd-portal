...
$$
J_{\text{out}} = \frac{1}{2}\rho \left( 1 + 6 \lambda_{\text{cat}} \rho \right)
$$
...
$$
J_{\text{linear}} = N_3 \cdot \mathbb{P}_0 = (N\rho) \cdot \frac{1}{2} = \frac{1}{2}N\rho
$$
...
$$
\mathbb{P}_{\text{eff}} = \frac{1}{2} + 3\lambda_{\text{cat}}\rho = \frac{1}{2}(1 + 6\lambda_{\text{cat}}\rho)
$$
...
$$
J_{\text{out}} = \rho \cdot \mathbb{P}_{\text{eff}} = \frac{1}{2}\rho (1 + 6\lambda_{\text{cat}}\rho)
$$
...
1. **Vacuum Permittivity:** The **Vacuum Permittivity** [(§5.2.3)](/monograph/rules/equilibrium/5.2/#5.2.3) establishes the baseline spontaneous loop closure probability at zero geometric density, yielding the background flux constant $\Lambda \approx 0.0156$.
2. **Geometric Autocatalysis:** The **Geometric Autocatalysis** [(§5.2.4)](/monograph/rules/equilibrium/5.2/#5.2.4) quantifies the induced loop creation flux scaling with the density of open 2-paths, establishing the non-linear growth component $9\rho^2$.
3. **Frictional Suppression:** The **Frictional Suppression** [(§5.2.5)](/monograph/rules/equilibrium/5.2/#5.2.5) enforces the exponential damping of update acceptance rates due to steric hindrance, imposing the suppression factor $e^{-6\mu\rho}$ where $\mu = \frac{1}{\sqrt{2\pi}}$.
4. **Entropic & Catalytic Decay:** The **Entropic & Catalytic Decay** [(§5.2.6)](/monograph/rules/equilibrium/5.2/#5.2.6) aggregates the spontaneous informational evaporation and quadratic catalytic stress terms, establishing the total deletion current $\frac{1}{2}\rho(1 + 6\lambda_{\text{cat}}\rho)$ where $\lambda_{\text{cat}} = e - 1$.
...
$$
\frac{d\rho}{dt} = (\Lambda + 9\rho^2)e^{-6\mu\rho} - \frac{1}{2}\rho(1 + 6\lambda_{\text{cat}}\rho)
$$
Expanding the deletion product yields the final structural form:
$$
\frac{d\rho}{dt} = (\Lambda + 9\rho^2)e^{-6\mu\rho} - \left( \frac{1}{2}\rho + 3\lambda_{\text{cat}}\rho^2 \right)
$$
