...
| $t_{phys}$ | Physical Time (emergent metric time) | [§1.2.2](/monograph/rules/ontology/1.2/#1.2.2) |
| $t_L$ | Global Logical Time (discrete iteration counter / coordinate clock) | [§1.2.3](/monograph/rules/ontology/1.2/#1.2.3) |
| $\mathbb{N}_0$ | Set of non-negative integers (Domain of $t_L$) | [§1.2.3](/monograph/rules/ontology/1.2/#1.2.3) |
| $U_{t_L}$ | Global state of the universe at step $t_L$ | [§1.2.3](/monograph/rules/ontology/1.2/#1.2.3) |
| $\mathcal{U}$ | Universal Evolution Operator | [§1.2.3](/monograph/rules/ontology/1.2/#1.2.3) |
| $\hat{H}$ | Hamiltonian constraint operator | [§1.2.3](/monograph/rules/ontology/1.2/#1.2.3) |
| $\Psi$ | Wavefunction of the universe | [§1.2.3](/monograph/rules/ontology/1.2/#1.2.3) |
| $\tau$ | Fictitious time parameter (Stochastic Quantization) | [§1.2.3.1](/monograph/rules/ontology/1.2/#1.2.3.1) |
| $\mu$ | Renormalization scale | [§1.2.3.1](/monograph/rules/ontology/1.2/#1.2.3.1) |
| $\hat{P}$ | Permutation Operator (CAI interpretation) | [§1.2.3.2](/monograph/rules/ontology/1.2/#1.2.3.2) |
| $\mathcal{T}$ | Unimodular Time variable | [§1.2.3.3](/monograph/rules/ontology/1.2/#1.2.3.3) |
| $\Lambda, \hat{\Lambda}$ | Cosmological Constant (variable/operator) | [§1.2.3.3](/monograph/rules/ontology/1.2/#1.2.3.3) |
| $S(U)$ | Information content/Entropy of state $U$ | [§1.2.5](/monograph/rules/ontology/1.2/#1.2.5) |
| $\mathcal{O}(\cdot)$ | Big O notation (asymptotic growth) | [§1.2.5](/monograph/rules/ontology/1.2/#1.2.5) |
| $\Omega_t$ | Set of admissible physical states at time $t$ | [§1.2.5.1](/monograph/rules/ontology/1.2/#1.2.5.1) |
| $b$ | Finite Branching factor | [§1.2.5.1](/monograph/rules/ontology/1.2/#1.2.5.1) |
| $s_t$ | Surface area (active degrees of freedom) | [§1.2.5.1](/monograph/rules/ontology/1.2/#1.2.5.1) |
| $\delta_{\text{holo}}$ | Holographic scaling constant | [§1.2.5.1](/monograph/rules/ontology/1.2/#1.2.5.1) |
| $T$ | Temporal Domain (Set of integers) | [§1.2.6.1](/monograph/rules/ontology/1.2/#1.2.6.1) |
| $\mathbb{Z}_{\le 0}$ | Set of non-positive integers (Infinite Past domain) | [§1.2.6.1](/monograph/rules/ontology/1.2/#1.2.6.1) |
| $\mathcal{H}_{\text{hist}}$ | History sequence (set of operations) | [§1.2.6.1](/monograph/rules/ontology/1.2/#1.2.6.1) |
| $\mu$ | Mean of entropy production (Context: Statistics) | [§1.2.6.1](/monograph/rules/ontology/1.2/#1.2.6.1) |
| $\sigma^2$ | Variance of entropy production | [§1.2.6.1](/monograph/rules/ontology/1.2/#1.2.6.1) |
| $\Delta I_k$ | Information bit contribution | [§1.2.6.1](/monograph/rules/ontology/1.2/#1.2.6.1) |
| $\Omega$ | Universal State Space (Set of all admissible graphs) | [§1.2.7.1](/monograph/rules/ontology/1.2/#1.2.7.1) |
| $\mathcal{P}_T$ | Trajectory sequence (Context: Recurrence Proof) | [§1.2.7.1](/monograph/rules/ontology/1.2/#1.2.7.1) |
| $\prec$ | Strict causal precedence | [§1.2.7.1](/monograph/rules/ontology/1.2/#1.2.7.1) |
| $\epsilon(op)$ | Energy cost per operation | [§1.2.8.1](/monograph/rules/ontology/1.2/#1.2.8.1) |
| $E_{total}$ | Total energy dissipated | [§1.2.8.1](/monograph/rules/ontology/1.2/#1.2.8.1) |
| $k_B$ | Boltzmann constant | [§1.2.8.2](/monograph/rules/ontology/1.2/#1.2.8.2) |
| $T$ | Temperature (Context: Thermodynamics) | [§1.2.8.2](/monograph/rules/ontology/1.2/#1.2.8.2) |
| $\hbar$ | Reduced Planck constant | [§1.2.8.2](/monograph/rules/ontology/1.2/#1.2.8.2) |
| $c$ | Speed of light | [§1.2.8.2](/monograph/rules/ontology/1.2/#1.2.8.2) |
| $G_{\mu\nu}$ | Einstein Tensor | [§1.2.8.2](/monograph/rules/ontology/1.2/#1.2.8.2) |
| $T_{\mu\nu}$ | Continuous stress-energy tensor | [§1.2.8.2](/monograph/rules/ontology/1.2/#1.2.8.2) |
| $R_s$ | Schwarzschild Radius | [§1.2.8.2](/monograph/rules/ontology/1.2/#1.2.8.2) |
| $U_0$ | The unique initial state | [§1.2.4](/monograph/rules/ontology/1.2/#1.2.4) |
| $R_n$ | The $n$-th Grim Reaper entity | [§1.2.9.1](/monograph/rules/ontology/1.2/#1.2.9.1) |
| $G$ | A specific Causal Graph $(V, E, H)$ | [§1.3.1](/monograph/rules/ontology/1.3/#1.3.1) |
| $V$ | Set of Vertices (Abstract Events) | [§1.3.2](/monograph/rules/ontology/1.3/#1.3.2) |
| $E$ | Set of Directed Edges (Causal Relations) | [§1.3.3](/monograph/rules/ontology/1.3/#1.3.3) |
| $H$ | History Function (Local proper time mapping $E \to \mathbb{N}$) | [§1.3.4](/monograph/rules/ontology/1.3/#1.3.4) |
| $v, u, w$ | Individual vertices | [§1.3.2](/monograph/rules/ontology/1.3/#1.3.2) |
| $e$ | Individual edge $(u, v)$ | [§1.3.3](/monograph/rules/ontology/1.3/#1.3.3) |
| $\text{In}(u)$ | Set of incoming edges to vertex $u$ | [§1.3.5](/monograph/rules/ontology/1.3/#1.3.5) |
...
| $\mathfrak{T}_{del}$ | Primitive Task: Edge Deletion | [§1.4.3](/monograph/rules/ontology/1.4/#1.4.3) |
| $\Delta F$ | Change in Free Energy | [§1.4.1.1](/monograph/rules/ontology/1.4/#1.4.1.1) |
