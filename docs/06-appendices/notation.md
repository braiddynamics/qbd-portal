...
| $\mathcal{T}$ | Unimodular Time variable (Context: Gravity) | [§1.2.2.3](/monograph/rules/ontology/1.2/#1.2.2.3) |
...
| $\mathcal{A}$ | Annotation structure $(a_V, a_E)$ | [§3.3.1](/monograph/rules/architecture/3.3/#3.3.1) |
...
| $\epsilon_{geo}$ | Internal energy of geometric creation | [§3.4.5](/monograph/rules/architecture/3.4/#3.4.5) |
...
| $\mathcal{C}$ | The Physical Codespace (Valid states) | [§3.5.1](/monograph/rules/architecture/3.5/#3.5.1) |
| $\bar{d}(u,v)$ | Undirected metric distance | [§3.5.1](/monograph/rules/architecture/3.5/#3.5.1) |
| $\Pi_{\text{cycle}}$ | Projector enforcing irreflexivity/asymmetry | [§3.5.1](/monograph/rules/architecture/3.5/#3.5.1) |
...
| $\mathcal{U}$ | Evolution Operator | [§4.6.1](/monograph/rules/dynamics/4.6/#4.6.1) |
...
| $c$ | Specific entropy per event (Capacity) | [§5.1.2](/monograph/rules/equilibrium/5.1/#5.1.2) |
...
| $\Lambda$ | Vacuum Permittivity (Ignition Flux) | [§5.2.3](/monograph/rules/equilibrium/5.2/#5.2.3) |
...
| $\rho^*$ | Equilibrium density (Fixed Point) | [§5.4.1](/monograph/rules/equilibrium/5.4/#5.4.1) |
...
| $\bar{d}(u,v)$ | Undirected shortest-path distance | [§5.5.2](/monograph/rules/equilibrium/5.5/#5.5.2) |
