...
How did these subtle acoustic waves crystallize into the vast network of galaxies, clusters, and voids we observe today? Tracing the gravitational dynamics that sculpted the modern Cosmic Web demonstrates that the large-scale structure of the universe is the macroscopic signature of the vacuum's pre-geometric correlations.
...
The structural and thermodynamic consequences established in **Void Relaxation** <Ref id="20.3.2" label="§20.3.2" /> govern the macroscopic expansion dynamics and global void geometry of the graph.
...
The hierarchy of deformations established in **Axis Collapse Hierarchy** <Ref id="20.3.3" label="§20.3.3" /> reveals how the sequential collapse of cosmic structures prevents isotropic collapse, seeding the web-like distribution of galaxies.
