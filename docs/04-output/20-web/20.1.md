...
Spacetime has crystallized, and matter has synthesized, leaving the early universe filled with a hot, dense, and opaque plasma of interacting photons and braids. Recombination maps the "Last Scattering Surface", the moment when the plasma cooled, became transparent, and released the Cosmic Microwave Background (CMB) as a fossilized snapshot of the graph's primordial complexity.
...
The physical and mathematical implications established in **Sachs-Wolfe Time Dilation** <Ref id="20.1.2" label="§20.1.2" /> demonstrate how gravitational potential wells govern the global properties of the causal geometry.
