...
*   **Gravitational Potential Wells:** By the discrete Einstein equations (**Discrete Field Equations** <Ref id="12.2" label="§12.2" />), these overdensities correspond to deep gravitational potential wells ($\Phi_c \propto \delta\rho_3$).
