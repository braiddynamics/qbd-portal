...
Before recombination, the universe was a hot, dense plasma of photons, electrons, and protons, coupled by Thomson scattering. Deriving the physics of Baryon Acoustic Oscillations (BAO) within the QBD framework demonstrates how competing entropic and gravitational forces on the graph substrate generate the characteristic peak structure of the CMB angular power spectrum.
...
The acoustic properties of the causal geometry follow directly from the balance of physical and entropic mechanisms established under **Gravitational and Entropic Competing Forces** <Ref id="20.2.2" label="§20.2.2" />.
...
:::info[**Sound Horizon as a Cosmic Ruler**]
:::
