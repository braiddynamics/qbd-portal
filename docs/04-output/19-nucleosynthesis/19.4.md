...
Let $(n_n/n_p)_0$ be the ratio of neutron to proton number densities at weak decoupling. In thermal equilibrium at temperature $T_f$, the ratio obeys the Boltzmann factor under **Weak Interaction Decoupling Scale** <Ref id="19.4.2" label="§19.4.2" /> and **Freeze-Out Abundance Ratio** <Ref id="19.4.3" label="§19.4.3" />:
