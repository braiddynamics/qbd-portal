...
Let $R_N(t)$ be the instantaneous creation rate of topological braid defects during graph updating relaxation. Under **Reheating Temperature** <Ref id="19.1.1" label="§19.1.1" /> and **Steric Density Relaxation Kinetics** <Ref id="19.1.2" label="§19.1.2" />, the creation rate is proportional to the square of the edge density excess above the homeostatic attractor:
