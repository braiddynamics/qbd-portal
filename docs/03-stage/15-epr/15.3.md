...
The **emergent throat lemma** [(§15.3.3)](/monograph/stage/epr/15.3/#15.3.3) formalizes the geometric shape of entanglement. When we say two particles are entangled, we typically visualize them as separate points with a mysterious "connection" line. However, the Min-Cut proof forces us to view this connection as a geometric feature: a **Throat**.
