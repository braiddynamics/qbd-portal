...
* Formulate the **Lapse Function** [(§14.1.1)](/monograph/stage/time/14.1/#14.1.1) from the local density of logical graph updates.
* Construct the **Lorentzian Metric** [(§14.2.1)](/monograph/stage/time/14.2/#14.2.1) with signature **(-+++)** under **3+1** foliation.
* Prove **Proper Time Maximization** [(§14.2.7)](/monograph/stage/time/14.2/#14.2.7) along geodesic trajectories.
* Verify the **Wightman Axioms** [(§14.3.2)](/monograph/stage/time/14.3/#14.3.2) for matter fields residing on the emergent manifold.
* Recover the classical **Einstein Field Equations** [(§14.4.1)](/monograph/stage/time/14.4/#14.4.1) from thermodynamic entanglement entropy.
:::
...
The **lapse function definition** [(§14.1.1)](/monograph/stage/time/14.1/#14.1.1) naturally recovers the phenomenon of **Gravitational Time Dilation** without postulating curved spacetime *a priori*. Curvature is simply the gradient of this processing speed.
