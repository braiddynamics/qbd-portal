...
In **Causal Isomorphism** <Ref id="14.2.4" label="§14.2.4" />, the primacy of cause over metric is established. in standard geometric formulations of General Relativity, the metric $g_{\mu\nu}$ is primary, and "causality" is a derivative property; you calculate the light cones *after* you define the distance.
