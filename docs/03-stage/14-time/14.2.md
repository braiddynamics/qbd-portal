...
The **Emergent Lorentzian Metric**, denoted $g_{\mu\nu}$, constitutes the fundamental dynamical tensor field on the differentiable manifold $M$. This tensor unifies the spatial Riemannian metric $g_{ij}$ **Smoothness Lemma** [(§13.1.5)](/monograph/stage/convergence/13.1/#13.1.5) and the scalar Lapse function $N$ [(§14.1.1)](/monograph/stage/time/14.1/#14.1.1) through the line element of the Arnowitt-Deser-Misner (ADM) decomposition:
...
2.  **Causal Determinism ($Ax2 \to \Sigma_t$):**
    ...
    * *Continuum Limit:* the **Global Hyperbolicity Lemma** [(§14.2.6)](/monograph/stage/time/14.2/#14.2.6) proves that the transitive closure of the graph maps to a globally hyperbolic spacetime foliated by Cauchy surfaces $\Sigma_t$.
...
3.  **Kinematic Universality ($Ax3 \to \Gamma^\mu_{\alpha\beta}$):**
    ...
    * *Continuum Limit:* the **Geodesic Motion Lemma** [(§14.2.7)](/monograph/stage/time/14.2/#14.2.7) establishes that the graph evolution operator $\mathcal{U}$ acts on these defects such that their stationary phase trajectory maximizes proper time $\tau$.
