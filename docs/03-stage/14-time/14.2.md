...
sidebar_label: "14.2 - Metric & Motion"
---
...
This Lemma establishes the primacy of cause over metric. in standard geometric formulations of General Relativity, the metric $g_{\mu\nu}$ is primary, and "causality" is a derivative property—you calculate the light cones *after* you define the distance.
