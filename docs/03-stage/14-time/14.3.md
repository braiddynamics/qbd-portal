...
sidebar_label: "14.3 - Overview"
---

## 14.3 Section: Field Axiomatics {#14.3}
:::note[**the **Local Quantum Field Theory Section** [(§14.3)](/monograph/stage/time/14.3/#14.3) Overview**]
...
$$
By ****directed causal link Axiom** [(§2.1.1)](/monograph/rules/axioms/2.1/#2.1.1)** (Causal Transfer), direct state influence propagates strictly along directed edges. Consequently, no sequence of updates originating at $u$ can affect the state at $v$ within the same logical time slice.
...
Fields with half-integer spin (topological fermions) obey Fermi-Dirac statistics (anticommutation relations), while fields with integer spin (topological bosons) obey Bose-Einstein statistics (commutation relations). This theorem is not an independent postulate but a necessary consequence of the topological phase $\phi = (-1)^{2s}$ established in **braid exchange topological phase** [(§7.1.2)](/monograph/players/topology/7.1/#7.1.2) combined with the Lorentz invariance of the emergent manifold. The consistency of the emergent Quantum Field Theory requires:
$$
\begin{cases}
...
****braid exchange topological phase Theorem** [(§7.1.2)](/monograph/players/topology/7.1/#7.1.2)** establishes that the exchange of two identical fermions (tripartite braids) induces a topological phase factor of $-1$. This phase arises from the non-trivial fundamental group of the configuration space of braids; exchanging two twisted ribbons requires a $360^\circ$ relative rotation, which for spinors corresponds to the phase $e^{i 2\pi (1/2)} = -1$.
...
1.  **Poincaré Covariance ($W_1$):** ****Poincaré Covariance Lemma** [(§14.3.3)](/monograph/stage/time/14.3/#14.3.3)** establishes that the statistical isotropy and homogeneity of the equilibrium graph converge to a unitary representation of the Poincaré group $U(\Lambda, a)$.
2.  **Vacuum Uniqueness ($W_2$):** ****Vacuum Invariance Lemma** [(§14.3.4)](/monograph/stage/time/14.3/#14.3.4)** proves that the maximum entropy state $|0\rangle$ is the unique, invariant ground state of the evolution operator, satisfying $P^\mu |0\rangle = 0$.
3.  **Spectral Condition ($W_3$):** ****Spectral Condition Lemma** [(§14.3.5)](/monograph/stage/time/14.3/#14.3.5)** demonstrates that the identification of mass with topological complexity ($N_3 \ge 0$) strictly confines the energy-momentum spectrum to the forward light cone $\bar{V}^+$, ensuring stability.
4.  **Microcausality ($W_4$):** ****Microcausality Lemma** [(§14.3.6)](/monograph/stage/time/14.3/#14.3.6)** validates that the strict acyclicity of the underlying graph enforces the commutativity of field operators at spacelike separations, preventing superluminal signaling.
5.  **Spin-Statistics ($W_5$):** ****Spin-Statistics Relation Lemma** [(§14.3.7)](/monograph/stage/time/14.3/#14.3.7)** confirms that the topological phases of braid exchange necessitate the assignment of Fermi-Dirac statistics to half-integer spin fields and Bose-Einstein statistics to integer spin fields.
