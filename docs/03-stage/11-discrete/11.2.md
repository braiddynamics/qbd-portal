...
sidebar_label: "11.2 - Causal Geometry Construction"
---
...
The definition of $K(u,v)$ provides a direct operational interpretation of curvature:
...
This theorem guarantees that the discrete Einstein-Hilbert action $\mathcal{S}[G] = \sum_{(u,v) \in E} K(u,v)$ is a well-defined functional for any physically realizable state of the causal graph.
