...
This section formally defines these components and proves that the resulting geometry is well-posed, establishing the mathematical arena in which **Curvature Monotonicity** <Ref id="11.3" label="§11.3" /> operates.
