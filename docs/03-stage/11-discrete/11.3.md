...
sidebar_label: "11.3 - Monotonicity Theorem"
---
...
The definition of the discrete action **discrete action definition** [(§11.3.1)](/monograph/stage/discrete/11.3/#11.3.1) performs the crucial work of translating the abstract concept of "gravity" into the mechanistic language of information transport. In the continuum of General Relativity, the Einstein-Hilbert action serves as a measure of the total curvature of spacetime, effectively quantifying how much the geometry deviates from flatness. In the discrete regime of Quantum Braid Dynamics, the action $\mathcal{S}$ reinterprets this deviation as a measure of the total "transport efficiency" of the causal graph.
