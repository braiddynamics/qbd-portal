...
**Holographic Renormalization Subtraction** <Ref id="16.4.4" label="§16.4.4" /> demonstrates that UV boundary divergences in holographic gravity correspond to local vacuum energy terms in boundary field theory. Removing these divergences isolates the physical, non-local energy-momentum tensor governing bulk spacetime dynamics.
