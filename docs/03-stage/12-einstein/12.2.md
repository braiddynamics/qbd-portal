...
3.  **Entropic Exclusion of Non-Locality:**
    ...
    This condition requires a high degree of mutual information $I(e_1; e_2)$ between spatially separated regions. However, the **correlation decay lemma** [(§5.1.3)](/monograph/rules/equilibrium/5.1/#5.1.3) restricts mutual information to $I \leq C e^{-d(e_1, e_2)/\xi}$.
