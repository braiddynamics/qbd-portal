...
The **Discrete Stress-Energy Tensor** <Ref id="12.1.1" label="§12.1.1" /> formulation identifies the terms in the brackets:
...
The proof integrates the stationarity condition (**Global Stationarity** <Ref id="12.1.3" label="§12.1.3" />) and the detailed balance relation (**Flux Separation (Detailed Balance)** <Ref id="12.1.4" label="§12.1.4" />) to establish the local conservation law.
