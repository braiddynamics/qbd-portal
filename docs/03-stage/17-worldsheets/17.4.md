...
1.  **The Unimodular Basis** <Ref id="17.4.3" label="§17.4.3" />: The argument establishes the even self-dual lattice requirement to satisfy modular S-invariance and ensure one-loop unitarity.
...
5.  **The Formal Synthesis** <Ref id="17.4.7" label="§17.4.7" />: The argument unifies the worldsheet factorization, critical dimensions, and modular lattice constraints to establish the non-perturbative isomorphism with Heterotic String Theory.
...
Verification of the Standard Model embedding established in the Standard Model Embedding Lemma **Standard Model Embedding Lemma** <Ref id="17.4.4" label="§17.4.4" /> is based on the following protocols:
...
The fundamental node of the causal graph is the Trivalent Vertex (one input, two outputs, or vice versa). As established in **Braid Saturation Lemma** <Ref id="17.3.3" label="§17.3.3" />, this structure governed the Left-Moving sector.
...
2.  **Critical Dimensions:** The topological constraints of the trivalent lattice (**Braid Saturation Lemma** <Ref id="17.3.3" label="§17.3.3" />) and the spinor stability (**Bott Periodicity Lemma** <Ref id="17.3.2" label="§17.3.2" />) fix the effective dimensions to $D_L=26$ and $D_R=10$.
3.  **Gauge Group:** The modular invariance of the graph sum forces the 16 internal left-moving bosons to compactify on the $\Gamma_{E_8 \times E_8}$ lattice (**E8 Lattice Theorem** <Ref id="17.4.2" label="§17.4.2" />).
...
Verification of the non-perturbative string limit established in the Heterotic Synthesis Proof **Heterotic Synthesis Proof** <Ref id="17.4.7" label="§17.4.7" /> is based on the following protocols:
