...
sidebar_label: "17.3 - The Critical Dimension (D=26)"
---
...
This Lemma relates to a deep fact in pure mathematics: there are only four "Division Algebras"—mathematical systems where you can add, subtract, multiply, and divide.
...
This Lemma resolves the strange asymmetry of the Heterotic String ($D=10$ on the right, $D=26$ on the left).
...
This Lemma explains why the universe looks 10-dimensional (or 4-dimensional) even though the graph has a 26-dimensional structure.
