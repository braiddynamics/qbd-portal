...
Assume the domain of the global logical time parameter $T$ extends to the infinite past. Then this unbounded configuration is excluded by the Finite Information Substrate [(§1.2.3)](/monograph/foundations/ontology/1.2/#1.2.3).
...
1.  **Thermodynamic Positivity:**
    ...
    The fluctuations are bounded by the Finite Information Substrate [(§1.2.3)](/monograph/foundations/ontology/1.2/#1.2.3):
...
4.  **Contradiction:**
    The divergence $S(U_0) \to \infty$ is excluded by the Finite Information Substrate [(§1.2.3)](/monograph/foundations/ontology/1.2/#1.2.3).
...
4.  **Contradiction:**
    An infinite information capacity $I(U_0) = \infty$ is excluded by the Finite Information Substrate [(§1.2.3)](/monograph/foundations/ontology/1.2/#1.2.3).
...
:::tip[**Formal Derivation of the Lower Bound on Logical Time via Reductio Ad Absurdum [(§1.2.7)](/monograph/foundations/ontology/1.2/#1.2.7)**]
:::
