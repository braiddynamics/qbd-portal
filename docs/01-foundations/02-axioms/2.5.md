...
The **Causal Primitive** [(§2.1.1)](/monograph/foundations/axioms/2.1/#2.1.1) and the **Geometric Primitive** [(§2.3.1)](/monograph/foundations/axioms/2.3/#2.3.1) are formally independent constraints. The satisfaction of the conditions of Axiom 1 does not logically entail the satisfaction of Axiom 2, nor does the satisfaction of Axiom 2 entail Axiom 1. The validity of this independence is established by the existence of specific graph models that satisfy one axiom while violating the other.
...
Let $G_A$ denote a chordless directed cycle of length 4. Then this structure satisfies the Irreflexivity and Asymmetry of **The Directed Causal Link** (Axiom 1) [(§2.1.1)](/monograph/foundations/axioms/2.1/#2.1.1), yet constitutes an irreducible configuration violating the Geometric Constructibility defined by Axiom 2 [(§2.3.1)](/monograph/foundations/axioms/2.3/#2.3.1).
...
Axiom 2 requires that valid geometry emerges exclusively from the closure of minimal directed 3-cycles [(§2.3.1)](/monograph/foundations/axioms/2.3/#2.3.1). The graph $G_A$ contains a cycle of length 4. The absence of chords precludes the decomposition of this cycle into constituent 3-cycles.
...
Let $G_B$ denote the graph formed by the disjoint union of a simple directed 3-cycle and an isolated vertex possessing a self-loop. Then this structure satisfies the criteria of Geometric Constructibility (Axiom 2) [(§2.3.1)](/monograph/foundations/axioms/2.3/#2.3.1), yet constitutes a configuration excluded by the Irreflexivity constraint of The Directed Causal Link (Axiom 1) [(§2.1.1)](/monograph/foundations/axioms/2.1/#2.1.1).
...
The Directed Causal Link imposes a universal prohibition on self-reference [(§2.1.1)](/monograph/foundations/axioms/2.1/#2.1.1).
...
Geometric Constructibility identifies the directed 3-cycle as the basis of spatial assembly [(§2.3.1)](/monograph/foundations/axioms/2.3/#2.3.1). The subgraph $C_1$ constitutes a valid instance of the geometric quantum.
...
:::tip[**Formal Synthesis of Independence via Orthogonal Counter-Models [(§2.5.1)](/monograph/foundations/axioms/2.5/#2.5.1)**]
:::
...
1.  **Direction 1 ($\neg(Ax1 \implies Ax2)$):**
    * *Model Construction:* **Lemma [§2.5.2](/monograph/foundations/axioms/2.5/#2.5.2)** constructs a graph $G_A$ consisting of a chordless directed 4-cycle.
...
2.  **Direction 2 ($\neg(Ax2 \implies Ax1)$):**
    * *Model Construction:* **Lemma [§2.5.3](/monograph/foundations/axioms/2.5/#2.5.3)** constructs a graph $G_B$ consisting of a disjoint union of a valid 3-cycle and an isolated self-loop ($C_3 \cup \{e_{loop}\}$).
