...
Furthermore, the **Universal Evolution Operator** $\mathcal{U}$ [(§4.6.1)](/monograph/foundations/dynamics/4.6/#4.6.1) acts via Pauli-$X$ bit-flips, which preserve the binary dimension.
