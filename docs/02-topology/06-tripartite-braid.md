...
4.  **Logical Protection:** The configuration occupies a protected logical subspace within the Quantum Error-Correcting Code codespace $\mathcal{C}$ [(§3.5.1.1)](/monograph/foundations/architecture/3.5/#3.5.1.1), characterized by the enforcement of $+1$ eigenvalues for the Geometric Stabilizers $K_{\text{geom}} = ZZZ$ [(§3.5.4)](/monograph/foundations/architecture/3.5/#3.5.4).
...
This state resides within the **QECC Codespace** $\mathcal{C}$ [(§3.5.7)](/monograph/foundations/architecture/3.5/#3.5.7).
