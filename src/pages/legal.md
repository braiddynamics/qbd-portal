...
* **You may:** View, compile, and run the code strictly to verify the theoretical results presented in this monograph.
* **You may NOT:** Copy, modify, distribute, sublicense, or sell the code in source or binary form.
* **You may NOT:** Use the code, or any derivative works, for any commercial purpose or integrate it into any product.

**Unauthorized commercial use, modification, or distribution is strictly prohibited.**

*This code is proprietary technology. For commercial licensing inquiries, joint ventures, or industrial applications, please contact the author directly.*
