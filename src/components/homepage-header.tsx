        ...
        <header className="hero-rn-style">
            <div className="container" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'center', gap: '1rem' }}>
                    <Link className="button button--primary button--lg btn-pulse-white-active" to="/monograph">
                        Table of Contents
                    </Link>
                    <Link className="button hero-white-btn button--lg btn-pulse-white-active" to="/monograph/intro/intro-a">
                        Introduction
                    </Link>
                </div>
            </div>
