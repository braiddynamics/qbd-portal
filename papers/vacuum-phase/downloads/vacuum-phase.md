...
The complete machine-checked Lean 4 formal verification proofs (48 active numbered verified theorems across 61 declarations), the high-performance multi-threaded C++20 simulation engine, and the standalone Python 3 reference implementation and prior verification suite are published in the companion open-source Markdown supplement:
